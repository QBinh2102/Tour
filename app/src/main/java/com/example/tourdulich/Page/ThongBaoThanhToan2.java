...
public class ThongBaoThanhToan2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thong_bao_thanh_toan2);
        ...
        btnQuayLaiTC.setOnClickListener(v -> {
            Intent intentBack = new Intent(ThongBaoThanhToan2.this, TrangChu.class);
